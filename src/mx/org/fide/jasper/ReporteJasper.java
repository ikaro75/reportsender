...
public class ReporteJasper {
    ...
    public final void setPrint(Conexion cx) throws Fallo {
      ...
      Connection conn = null;
        ...
        try {
            JasperReport jasperReport = JasperCompileManager.compileReport(this.jrxml.concat(".jrxml"));
            this.jp = JasperFillManager.fillReport(jasperReport, this.parametros, conn);
     ...
     * @throws Fallo si ocurre un error al acceder a la base de datos
     */
    public ReporteJasper(String reporte, String jrxml) throws Fallo {
        this.claveReporte = 0;
        ...
        try {
            ...
            this.jsp = null;
            this.jrxml = jrxml;
            this.generarEnInsercion = false;
            this.generarEnActualizacion = false;
        } catch (Exception e) {
            throw new Fallo(e.getMessage());
        } 
    }
